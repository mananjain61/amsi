...
if ($Method -eq "RDP") {
    ...
    if ($CurrentUser) {
        if ($Hash -ne "" -or $Password -ne "" -or $Username -ne "" -or $Ticket -ne "") {
            ...
            Write-Host "[*] " -ForegroundColor "Yellow" -NoNewline
            Write-Host "MapSSSS will continue in the current users context """
...
Write-Host
Write-host "MapSSSS -Method Spray -SprayPassword [Password]"
Write-host "MapSSSS -Method Spray -SprayHash [Hash]"
Write-host "MapSSSS -Method Spray -AccountAsPassword"
Write-host "MapSSSS -Method Spray -EmptyPassword"
return
            ...
            foreach ($match in $matches) {
                ...
                if ($notes -ne "") {
                    ...
                    if ($ticketSearchText -match $ticketPattern) {
                        ...
                        Write-Host "Impersonate   : MapSSSS -Targets All -Method WMI -Ticket `$$randomVarName"
                        Write-Host
